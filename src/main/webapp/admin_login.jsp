	...
	<div id="dwBody" >
		<div id="dwBodyContent" class="bodyCenter" style="background: none;">
					...
					<div id="dwLoginContent">
						...
						<div class="dlcTitle" >
							<a href="#" class="dlcTitleTab crt" >管理员—查询</a>
						</div>
					...
					<div class="loginFormContent">
							...
							<div class="dlcLeft">
								<div class="frmItem">
									...
									<div class="frm_controls">
										<input id="username" type="text" class="frm-controlM" name="username" value="" placeholder="请输入管理员账号" >
								...
								<div class="frmItem">
									...
									<div class="frm_controls">
										<input type="password"  name="password" id="passwordInput"  class="frm-controlM" value="" placeholder="请输入管理员密码"  >
						...
						<div class="dlcRight">
							...
							<div style="color: gray;">
								...
								<p style="line-height: 40px;">电话：010-58801910  </p>
