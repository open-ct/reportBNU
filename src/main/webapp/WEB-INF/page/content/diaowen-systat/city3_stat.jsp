							...
							<div style="padding-left: 20px;padding-top: 8px;padding-bottom: 8px;font-size: 18px;color: #6cb158;">
								<%--亲爱的同学：<br/>--%>
									<div style="text-indent: 26px;">
										...
										<hr/>
										<div class="n_item_1">
											<div><label style="color: #89b134;">总用户数：${cityAnswerStat.totalUser+cityAnswerStat.totalUserStu11+cityAnswerStat.totalUserStu21}&nbsp;&nbsp;</label></div>
											<div class="n_detail_1" style="font-size: 14px;">
												<div>
													<label>小学生：${cityAnswerStat.totalUserStu11}&nbsp;&nbsp;</label>
													<label>小学生家长：${cityAnswerStat.totalUserStu11}&nbsp;&nbsp;</label>
													<label>小学教师：${cityAnswerStat.totalUserTea13}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>中学生：${cityAnswerStat.totalUserStu21}&nbsp;&nbsp;</label>
													<label>中学生家长：${cityAnswerStat.totalUserStu21}&nbsp;&nbsp;</label>
													<label>中学教师：${cityAnswerStat.totalUserTea23}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>小学校长：${cityAnswerStat.totalUserXz14}</label>
													<label>中学校长：${cityAnswerStat.totalUserXz24}</label>
										...
										<div class="n_item_1">
											<div>
												...
												<%--${joinUsersNum/schoolCountUser * 100}%--%>
													<fmt:formatNumber type="number" value="${(cityAnswerStat.joinUser/(cityAnswerStat.totalUser+cityAnswerStat.totalUserStu11+cityAnswerStat.totalUserStu21))*100 }" pattern="0.00" maxFractionDigits="2"/>%
												</span>
											</div>
											<div class="n_detail_1" style="font-size: 14px;">
												<div>
													<label>小学生：${cityAnswerStat.joinUserStu11}&nbsp;&nbsp;</label>
													<label>小学生家长：${cityAnswerStat.joinUserJz12}&nbsp;&nbsp;</label>
													<label>小学教师：${cityAnswerStat.joinUserTea13}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>中学生：${cityAnswerStat.joinUserStu21}&nbsp;&nbsp;</label>
													<label>中学生家长：${cityAnswerStat.joinUserJz22}&nbsp;&nbsp;</label>
													<label>中学教师：${cityAnswerStat.joinUserTea23}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>小学校长：${cityAnswerStat.joinUserXz14}</label>
													<label>中学校长：${cityAnswerStat.joinUserXz24}</label>
												</div>
											</div>
										</div>
										...
										<div class="n_item_1">
											...
											<div class="n_detail_1" style="font-size: 14px;">
												<div>
													<label>小学生答卷数：${cityAnswerStat.answerSumStu11}&nbsp;&nbsp;</label>
													<label>小学生家长答卷数：${cityAnswerStat.answerSumJz12}&nbsp;&nbsp;</label>
													<label>小学教师答卷数：${cityAnswerStat.answerSumTea13}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>中学生答卷数：${cityAnswerStat.answerSumStu21}&nbsp;&nbsp;</label>
													<label>中学生家长答卷数：${cityAnswerStat.answerSumJz22}&nbsp;&nbsp;</label>
													<label>中学教师答卷数：${cityAnswerStat.answerSumTea23}&nbsp;&nbsp;</label>
												</div>
												<div>
													<label>小学校长答卷数：${cityAnswerStat.answerSumXz14}</label>
													<label>中学校长答卷数：${cityAnswerStat.answerSumXz24}</label>
												</div>
											</div>
										</div>
