...
<div class="header_Item header_logo">
		<a href="${ctx }/"><img alt="调问网" src="${ctx }/images/logo/logo-xt.png" height="40" ></a>
							...
							<div class="quInputCase" style="display: none;">
								...
								<c:forEach items="${en.questionLogics }" var="quLogicEn" varStatus="logicSts">
									<div class="quLogicItem quLogicItem_${logicSts.count }">
										...
										<input type="hidden" name="skQuIdEnd" value="${quLogicEn.skQuIdEnd }"/>
...
<div class="quLogicItem">
	...
	<input type="hidden" name="skQuIdEnd" value="0"/>
...
<table id="setQuLogicItem" style="display: none;">
	<tr id="setQuLogicItemTrModel">
		...
		<td>则&nbsp;<select name="option_id" class="logicType"  style="width: 80px;">
			<option value="2">显示</option><option value="1">跳到</option><option value="3">显示区域</option></select> </td>
		<td>
			<select name="jump_to_qid" class="logicQuSel" ></select>
			<select name="jump_to_qid" class="logicQuSel" style="display: none;" ></select>
		</td>
		...
		<div class="dwCommonDialogContent">
			...
			<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li class="maxNumLi" style="display: none;">最多选&nbsp;<input type="text" size="3" name="maxNum">&nbsp;项 </li>
					<li class="minMaxLi">
					...
					<li class="scoreMinMax">&nbsp;&nbsp;<label>最高分</label>&nbsp;
						<select class="maxScore"  ><option value="5">5分</option><option value="7">7分</option><option value="10">10分</option></select>&nbsp; </li>
				</ul>
			...
			<div class="tabbarDialog_1" >
					<div class="p_DialogContent" >
						...
						<div class="p_DialogContentRoot">
								<div class="p_DialogContentItem"><label>答题时限（分钟）：<input type="text" size="12" class="inputSytle_1" name="limitTime"></label></div>
...
<script type="text/javascript">
	...
	$("input[name='limitTime']").val("${survey.surveyDetail.limitTime}");
