				...
				<div class="tabbarDialog">
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
								<div class="p_DialogContentItem"><label>答题时限：<input value="${survey.surveyDetail.limitTime}" name="limitTime" type="text" size="10"  class="inputSytle_1"></label></div>
			...
			<li style="display: none;">
				...
				<div class="tabbarDialog">
					<div class="p_DialogContent">
						<div class="p_DialogContentTitle">回答限制</div>
						<div class="p_DialogContentRoot">
								<div class="p_DialogContentItem"><label>答题时限：<input type="text" size="8"  class="inputSytle_1"></label></div>
