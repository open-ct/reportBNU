...
<body style="background:#518861;">
	<div class="home-title" style="letter-spacing: 6px;font-size: 36px;margin: 60px 0px;">区域教育质量健康体检项目在线报告系统</div>
    ...
    <div class="home-modules">
    	<ul>
        	<li style="float:none; margin:0 auto">
                ...
                <div class="module-name">登录系统<span style=""></span></div>
                <div class="module-enter"><a href="admin_login.jsp" class="btn">点击进入</a></div>
            </li>
            <!--
            <li>
